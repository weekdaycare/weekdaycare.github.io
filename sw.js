        ...
        caches.open(cacheName).then(function (cache) {
            ...
            if (clients && clients.length) {
                clients.forEach(function (client) {
                    if (contentUpdated) {
                        client.postMessage('sw.update');  // 如果内容有更新，发送 'sw.update'
                    } else {
                        client.postMessage('sw.version');  // 如果内容无更新，发送 'sw.version'
                    }
                })
            }
        })
